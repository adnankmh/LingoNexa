...
3. افتح تبويب **Actions** وشغّل Workflow باسم **Build LingoNexa**.
4. بعد النجاح افتح تشغيل الـ Workflow ثم قسم **Artifacts** وحمّل `lingonexa-android`؛ بداخله APK وAAB.
5. للنشر على GitHub Pages: من **Settings → Pages → Build and deployment** اختر **GitHub Actions**.
