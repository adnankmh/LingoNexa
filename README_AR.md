...
الإصدار الحالي: **2.0.0+12 — Global Academy**
...
3. من GitHub Desktop تأكد أن الملفات `.github/workflows/` موجودة ضمن التغييرات، اكتب Summary مثل `LingoNexa 2.0.0` واضغط **Commit to main** ثم **Push origin**.
