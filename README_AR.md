...
- امتحان لكل مستوى A1–C2 بنتيجة نجاح 70% ومكافآت XP وفتح المستوى التالي، ومكتبة 36 نشاط قصة حوارية عبر المستويات لكل مسار لغة.
...
> مهم بخصوص دقة المحتوى: اللغات الأساسية الـ12 تمتلك بنكًا موسعًا من 37 مفهومًا متطابقًا (444 مدخلًا محليًا و1,776 تدريبًا مولدًا). اللغات الـ55 الأخرى تعرض Starter Lexicon المتحقق فقط. تم منع الرجوع إلى كلمات إنجليزية على أنها كلمات من اللغة المختارة. هذا أكثر أمانًا من ملء التطبيق بترجمات تخمينية، لكنه يعني أن التوسعة التجارية الحقيقية تحتاج مراجعين ومتحدثين أصليين وحزم محتوى مرخصة.
