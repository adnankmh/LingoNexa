...
الإصدار الحالي: **1.6.0+11 — Global Learning Hub**
...
3. من GitHub Desktop تأكد أن الملفات `.github/workflows/` موجودة ضمن التغييرات، اكتب Summary مثل `LingoNexa 1.6.0` واضغط **Commit to main** ثم **Push origin**.
