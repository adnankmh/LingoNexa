...
class _LevelExamScreenState extends State<LevelExamScreen> {
  ...
  void didChangeDependencies() {
    ...
    final seen = <String>{};
    _questions = CourseRepository.unitsFor(code,
              ...
              child: Column(children: [
                ClipRRect(
                    ...
                    child: LinearProgressIndicator(
                        value: (_index + 1) / _questions.length, minHeight: 9)),
  ...
  Future<void> _play(String text, LanguageOption language) async {
    final spoken = await _speech.speak(text, language.code,
            ...
            child: Padding(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Text('${language.flag} ${widget.level} · $_score%',
                        style: TextStyle(
