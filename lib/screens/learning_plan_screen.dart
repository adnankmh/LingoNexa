...
class _LearningPlanScreenState extends State<LearningPlanScreen> {
  ...
  static const _days = [
    ...
    (
      'TUE',
      'Listening lab',
      'Short audio + shadowing',
      Icons.headphones_rounded
    ),
    (
      'WED',
      'Grammar focus',
      'One pattern in context',
    ...
    (
      'SAT',
      'Culture day',
      'Article + useful expressions',
      Icons.public_rounded
    ),
    (
      'SUN',
      'Weekly review',
      'Mistakes + spaced recall',
              ...
              children: [
                Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        Text(
                            '${language.flag} ${state.learningReason} plan · ${state.currentLevel}',
                        ...
                        Text(
                            '${state.dailyGoalMinutes} minutes a day · adaptive weekly mix',
                        ...
                        Text(
                            '${_finished.length}/${_days.length} sessions complete',
                            style: const TextStyle(
                                color: Colors.white,
                  ...
                  Card(
                    child: CheckboxListTile(
                      ...
                      onChanged: (value) => setState(() => value == true
                          ? _finished.add(index)
                          : _finished.remove(index)),
                      secondary:
                          CircleAvatar(child: Icon(_days[index].$4, size: 20)),
                      title: Text('${_days[index].$1} · ${_days[index].$2}',
                ...
                Card(
                  ...
                  child: const ListTile(
                    ...
                    title: Text('Coach insight',
                        style: TextStyle(fontWeight: FontWeight.w900)),
                    subtitle: Text(
                        'Short daily sessions outperform one long session. Review difficult items before adding new vocabulary.'),
                  ),
                ),
              ],
            ),
