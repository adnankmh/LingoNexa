...
class CertificatesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final total = CourseRepository.unitsFor(language.code)
              ...
              children: [
                Container(
                  ...
                  child: Column(children: [
                    const Icon(Icons.workspace_premium_rounded,
                        size: 66, color: Colors.amber),
                    const SizedBox(height: 10),
                    Text('LingoNexa Learning Record',
                    ...
                    const SizedBox(height: 8),
                    Text('$completed of $total lesson nodes complete',
                ...
                FilledButton.icon(
                  onPressed: readiness >= 1
                      ? () => _showCertificate(
                          context, language.englishName, state.currentLevel)
                      : null,
                  icon: const Icon(Icons.card_membership_rounded),
                  label: Text(readiness >= 1
                      ? 'Preview certificate'
  ...
  static void _showCertificate(
      BuildContext context, String language, String level) {
    showDialog<void>(
      context: context,
