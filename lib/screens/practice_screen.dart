...
class PracticeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final allLessons = CourseRepository.unitsFor(state.targetLanguageCode,
    ...
    return ResponsivePage(
      child: Column(
        ...
        children: [
          Text(context.text.get('practice'),
              ...
              children: [
                const Expanded(
                    child: Column(
                      ...
                      SizedBox(height: 6),
                      Text('8 items are ready at the best moment for recall.',
              ...
              final items = [
                ...
                FeatureTile(
                    ...
                    onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (_) =>
                                LessonScreen(lesson: allLessons[1])))),
                FeatureTile(
                    ...
                    onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (_) =>
                                LessonScreen(lesson: allLessons[3])))),
                FeatureTile(
                    ...
                    onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (_) =>
                                LessonScreen(lesson: allLessons[5])))),
                FeatureTile(
                ...
                FeatureTile(
                    ...
                    onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (_) =>
                                LessonScreen(lesson: allLessons[4])))),
                FeatureTile(
          ...
          const Card(
            child: Padding(
              ...
              child: Column(children: [
                _SkillBar(
                    label: 'Vocabulary', value: .72, color: Color(0xFF6C63FF)),
                _SkillBar(
                    label: 'Listening', value: .58, color: Color(0xFF4DABF7)),
                _SkillBar(
                    label: 'Speaking', value: .44, color: Color(0xFF20C997)),
                _SkillBar(
                    label: 'Grammar', value: .63, color: Color(0xFFFFA94D)),
              ]),
            ),
          ),
        ],
        ...
        Expanded(
            child: ClipRRect(
                ...
                child: LinearProgressIndicator(
                    value: value, minHeight: 9, color: color))),
