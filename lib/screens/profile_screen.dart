        ...
        children: [
          Row(children: [
            Container(
                ...
                child: Text(
                    user.displayName
                        .substring(
                            0, user.displayName.length.clamp(1, 2).toInt())
                        .toUpperCase(),
            ...
            Expanded(
                child: Column(
                  ...
                  Row(children: [
                    ...
                    Text(' ${state.streak} days  ·  ${state.xp} XP',
                        style: const TextStyle(
              ...
              child: Column(
                  ...
                  children: [
                    Row(children: [
                      ...
                      Expanded(
                          child: Text('XP level ${state.xp ~/ 500 + 1}',
                              style: const TextStyle(
                                  fontWeight: FontWeight.w900))),
                      Text('${state.xp}/$nextXp XP',
                          style: const TextStyle(
          ...
          Card(
            child: Column(children: [
              ListTile(
                  ...
                  title: Text(context.text.get('learning_plan'),
              ...
              ListTile(
                  ...
                  title: Text(context.text.get('downloads'),
                      style: const TextStyle(fontWeight: FontWeight.w800)),
                  subtitle: Text(
              ...
              ListTile(
                  ...
                  title: Text(context.text.get('certificates'),
                      style: const TextStyle(fontWeight: FontWeight.w800)),
          ...
          Card(
            child: Column(children: [
              ListTile(
                  ...
                  title: Text(context.text.get('learning_language'),
                      style: const TextStyle(fontWeight: FontWeight.w800)),
              ...
              ListTile(
                  ...
                  title: Text(context.text.get('interface_language'),
                      style: const TextStyle(fontWeight: FontWeight.w800)),
                  subtitle: Text(
              ...
              SwitchListTile(
                  ...
                  title: Text(context.text.get('offline'),
                      style: const TextStyle(fontWeight: FontWeight.w800)),
                  subtitle: const Text(
              ...
              SwitchListTile(
                  ...
                  title: const Text('Fast learning mode',
              ...
              ListTile(
                  ...
                  title: const Text('Rebuild my learning plan',
                      style: TextStyle(fontWeight: FontWeight.w800)),
                  subtitle:
                      const Text('Restart onboarding and placement choices'),
                  trailing: const Icon(Icons.chevron_right_rounded),
          ...
          Card(
            child: ListTile(
                ...
                title: Text(context.text.get('premium'),
          ...
          if (state.isAdmin)
            Card(
              child: ListTile(
                  ...
                  title: Text(context.text.get('admin'),
                      style: const TextStyle(fontWeight: FontWeight.w900)),
                  subtitle: const Text(
          ...
          Card(
              child: ListTile(
                  ...
                  title: Text(context.text.get('sign_out'),
                      style: const TextStyle(fontWeight: FontWeight.w900)),
          ...
          Center(
              child: Text('LingoNexa 1.3.0 · Original Flutter platform',
                  style: TextStyle(
  ...
  Widget build(BuildContext context) => GestureDetector(
      ...
      child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                  color:
                      selected ? preset.seed : Theme.of(context).dividerColor,
                  width: selected ? 3 : 1)),
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            Container(
                ...
                height: 25,
                decoration:
                    BoxDecoration(color: preset.seed, shape: BoxShape.circle),
                child: selected
