              ...
              child: Row(
                children: [
                  ...
                  PopupMenuButton<String>(
                    ...
                    onSelected: (code) =>
                        AppStateScope.of(context).setLocale(code),
                    itemBuilder: (context) => [
            ...
            Expanded(
              child: PageView(
                ...
                children: [
                  ...
                  _LanguageStep(
                      selectedCode: _targetCode,
                      onSelected: (value) =>
                          setState(() => _targetCode = value)),
                  _ReasonStep(
                      selected: _reason,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: FilledButton(
                        ...
                        child: Text(
                            _page == 3 ? 'Build my learning plan' : 'Continue'),
                      ),
                    ),
                  ],
                ),
  ...
  Future<void> _finish() async {
    ...
    final takePlacement = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
            'Take a short placement check to choose a better starting level, or begin safely from A1.'),
        actions: [
          TextButton(
              onPressed: () => Navigator.pop(context, false),
              child: const Text('Start at A1')),
          FilledButton(
              onPressed: () => Navigator.pop(context, true),
              child: const Text('Placement check')),
        ],
      ),
    );
    ...
    await state.completeOnboarding(
        targetCode: _targetCode, goalMinutes: _goal, reason: _reason);
  }
}
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return SingleChildScrollView(
          padding:
              EdgeInsets.symmetric(horizontal: 28, vertical: compact ? 14 : 28),
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text('A world of language, built around you.',
                  ...
                  Text(
                      'Structured courses, real-world speaking, memory science, culture, and a global community in one original experience.',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                  ...
                  FilledButton.icon(
                      ...
                      label: const Text('Create my path')),
                ],
              ),
            ),
          ),
      ...
      child: ConstrainedBox(
        ...
        child: Column(
          children: [
            ...
            Text(
                '${LanguageCatalog.all.length} languages are available in the catalog',
                style: TextStyle(
                    color: Theme.of(context).colorScheme.onSurfaceVariant)),
                  ...
                  shape: RoundedRectangleBorder(
                      ...
                      side: BorderSide(
                          color: selected == reason.$1
                              ...
                              : Theme.of(context).dividerColor)),
                  child: ListTile(
                      onTap: () => onSelected(reason.$1),
                      contentPadding: const EdgeInsets.symmetric(
                          horizontal: 17, vertical: 5),
                      leading:
                          Text(reason.$2, style: const TextStyle(fontSize: 30)),
                      title: Text(reason.$1,
                          style: const TextStyle(fontWeight: FontWeight.w900)),
                      subtitle: Text(reason.$3),
                      trailing: selected == reason.$1
...
class _GoalStep extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const goals = [
      (5, 'Gentle', 'Build the habit'),
      (10, 'Regular', 'Steady daily progress'),
      (20, 'Focused', 'Recommended balance'),
      (30, 'Intensive', 'Move faster'),
      (45, 'Immersion', 'Serious daily study')
    ];
    return Center(
      child: ConstrainedBox(
