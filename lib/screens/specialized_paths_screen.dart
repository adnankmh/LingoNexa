            ...
            children: [
              Row(children: [
                Container(
                    ...
                    child:
                        Text(path.emoji, style: const TextStyle(fontSize: 30))),
                const Spacer(),
                Container(
                    padding:
                    ...
                    child: Text('${path.modules} modules',
                        style: TextStyle(
                            color: color,
                ...
                Expanded(
                    child: ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                            value: .08, minHeight: 7, color: color))),
                        ...
                        leading: CircleAvatar(
                            ...
                            child: Text('${i + 1}',
                                style: TextStyle(
                                    color: color,
                                    fontWeight: FontWeight.w900))),
                        title: Text(moduleNames[i % moduleNames.length],
                            style:
