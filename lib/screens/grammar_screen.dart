...
class _GrammarScreenState extends State<GrammarScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final verified = LearningContentRepository.phrasesFor(language.code,
    ...
    final topics = LearningContentRepository.grammarTopics
        ...
        .toList();
    return Scaffold(
      appBar: AppBar(title: const Text('Grammar Atlas'), actions: [
        Padding(
                ...
                Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Text(_languageProfile(language.code, language.script),
    ...
    return Card(
      ...
      child: ExpansionTile(
        ...
        children: [
          ...
          Align(
              alignment: AlignmentDirectional.centerStart,
              child: Text('Verified target-language examples',
                  style: TextStyle(
